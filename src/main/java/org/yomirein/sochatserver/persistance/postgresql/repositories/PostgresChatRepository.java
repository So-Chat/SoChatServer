...
import static org.yomirein.sochatserver.persistance.postgresql.repositories.PostgresUserRepository.mapUser;

public class PostgresChatRepository extends ChatRepository {

    private final Connection connection;

    public PostgresChatRepository(Connection connection) {
        super(connection);
